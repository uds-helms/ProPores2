...
public:
    PoreIDTest() :
            g_psp("test_files/psp_scan.pdb", 1.0, 1.0, false, false),
            a_psp(g_psp.atoms[0]),
            g_col("test_files/collision_detection.pdb", 1.0, 1.0, false, false),
            g_cyl("test_files/cylinder_completion.pdb", 1.0, 1.0, false, false),
...
TEST(pore_id_tests, seal_gaps_pore) {
    ProteinGrid g_pore = ProteinGrid("test_files/pore.pdb", 1.0, 1.0, false, false);
...
TEST(pore_id_tests, seal_gaps_cavity) {
    ProteinGrid g_cav = ProteinGrid("test_files/cavity.pdb", 1.0, 1.0, false, false);
...
TEST(pore_id_tests, compute_volumes_pore_plus_cavity) {
    ProteinGrid g_pore = ProteinGrid("test_files/pore_plus_cavity.pdb", 1.0, 1.0, false, false);
    collision_detection(g_pore);
    cylinder_completion(g_pore);
    perpendicularity_cylinder(g_pore);
    seal_gaps(g_pore);
